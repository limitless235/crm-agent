...
function AuthFormContainer({ isSignIn, onToggle, children }: { isSignIn: boolean; onToggle: () => void; children?: React.ReactNode }) {
    return (
        <div className="mx-auto grid w-[350px] gap-2">
            {children ? children : (isSignIn ? <SignInForm /> : <SignUpForm />)}
            ...
            <div className="relative text-center text-sm py-4 after:absolute after:inset-0 after:top-1/2 after:z-0 after:flex after:items-center after:border-t after:border-border">
...
export function AuthUI({
    ...
    const [isSignInInternal, setIsSignInInternal] = useState(true);

    const isSignIn = isSignInProp !== undefined ? isSignInProp : isSignInInternal;
    const toggleForm = onToggle || (() => setIsSignInInternal((prev) => !prev));
    ...
    return (
      ...
      `}</style>
            ...
            >
                ...
                <div className="absolute inset-x-0 bottom-0 h-[200px] bg-gradient-to-t from-background via-background/80 to-transparent" />
                ...
                <div className="relative z-10 flex h-full flex-col items-center justify-end p-12 pb-16">
                    <blockquote className="space-y-4 text-center">
                        ...
                        <cite className="block text-lg font-light text-white/80 not-italic">
